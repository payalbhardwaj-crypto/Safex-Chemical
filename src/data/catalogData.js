...
export const CATALOG_CATEGORIES = [
  ...
  },
  {
    ...
    products: [
      { id: 'weed-01', img: '', name: 'Grassout',   composition: 'Paraquat Dichloride 24% SL',     category: 'Weedicides' },
      { id: 'weed-02', img: '', name: 'Totalweed',  composition: 'Glyphosate 41% SL',              category: 'Weedicides' },
      { id: 'weed-03', img: '', name: 'Gramicide',  composition: 'Glufosinate Ammonium 13.5% SL', category: 'Weedicides' },
      { id: 'weed-04', img: '', name: 'Butadol',    composition: 'Butachlor 50% EC',               category: 'Weedicides' },
      { id: 'weed-05', img: '', name: 'Fluzap',     composition: 'Fluazifop-P-butyl 13.4% EC',    category: 'Weedicides' },
    ],
  },     
  {
    id: 'fungicides',
    ...
    products: [
      { id: 'fung-01', img: '', name: 'Tiger GR',   composition: 'Sulphur 90% Granule',                              category: 'Fungicides' },
      { id: 'fung-02', img: '', name: 'Cymate',     composition: 'Cymoxanil 8% + Mancozeb 64% WP',                  category: 'Fungicides' },
      { id: 'fung-03', img: '', name: 'Hallabol',   composition: 'Azoxystrobin 11% + Tebuconazole 18.3% SC',        category: 'Fungicides' },
      { id: 'fung-04', img: '', name: 'Blastox',    composition: 'Tricyclazole 75% WP',                             category: 'Fungicides' },
      { id: 'fung-05', img: '', name: 'Hexacare',   composition: 'Hexaconazole 5% EC',                              category: 'Fungicides' },
      { id: 'fung-06', img: '', name: 'Funguard',   composition: 'Propiconazole 25% EC',                            category: 'Fungicides' },
      { id: 'fung-07', img: '', name: 'Copzone',    composition: 'Copper Oxychloride 50% WP',                       category: 'Fungicides' },
      { id: 'fung-08', img: '', name: 'Mancure',    composition: 'Mancozeb 75% WP',                                 category: 'Fungicides' },
    ],
  },
  {
    id: 'insecticides',
    ...
    products: [
      { id: 'insc-01', img: '', name: 'Acarifas',   composition: 'Broflanilide 300 G/L SC',                             category: 'Insecticides' },
      { id: 'insc-02', img: '', name: 'Girdle',     composition: 'Chlorantraniliprole 18.5% SC',                        category: 'Insecticides' },
      { id: 'insc-03', img: '', name: 'Fipro Ultra',composition: 'Fipronil 0.6% GR',                                    category: 'Insecticides' },
      { id: 'insc-04', img: '', name: 'Nato',       composition: 'Emamectin Benzoate 3% + Thiamethoxam 12% WG',         category: 'Insecticides' },
      { id: 'insc-05', img: '', name: 'Dabang',     composition: 'Lambda Cyhalothrin 4.9% CS',                          category: 'Insecticides' },
      { id: 'insc-06', img: '', name: 'Aphikill',   composition: 'Imidacloprid 17.8% SL',                               category: 'Insecticides' },
      { id: 'insc-07', img: '', name: 'Acepro',     composition: 'Acephate 75% SP',                                     category: 'Insecticides' },
      { id: 'insc-08', img: '', name: 'Profex',     composition: 'Profenofos 40% + Cypermethrin 4% EC',                 category: 'Insecticides' },
      { id: 'insc-09', img: '', name: 'Chlorotuff', composition: 'Chlorpyrifos 20% EC',                                 category: 'Insecticides' },
    ],
  },
  {
    id: 'pgrs-bio',
    ...
    products: [
      { id: 'pgr-01', img: '', name: 'Bahaar',      composition: 'Organic Manure',                                  category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-02', img: '', name: 'Bahubali',    composition: 'Mycorrhiza',                                      category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-03', img: '', name: 'RootBoost',   composition: 'Phosphate Solubilizing Bacteria 10⁸ CFU/mL',     category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-04', img: '', name: 'GreenGrow',   composition: 'Trichoderma viride 1% WP',                       category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-05', img: '', name: 'Cytovit',     composition: 'Cytokinin 0.09% SL',                             category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-06', img: '', name: 'BioActiv',    composition: 'Humic Acid 98% WG',                              category: 'PGRs & Bio Fertilisers' },
      { id: 'pgr-07', img: '', name: 'SeaMax',      composition: 'Seaweed Extract 0.1% L',                         category: 'PGRs & Bio Fertilisers' },
    ],
  },
  {
    id: 'fertilisers',
